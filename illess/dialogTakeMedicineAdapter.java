...
public class dialogTakeMedicineAdapter extends RecyclerView.Adapter<dialogTakeMedicineAdapter.ViewHolder>{
    private ArrayList<String> List;
    private illess_frontpage Context;

    public dialogTakeMedicineAdapter(ArrayList<String> list, illess_frontpage context) {
        List = list;
        Context = context;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Context.createIntervalDialog(holder.illName.getText().toString());
            }
        });
    }
