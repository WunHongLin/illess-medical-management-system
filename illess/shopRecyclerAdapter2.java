...
public class shopRecyclerAdapter2 extends RecyclerView.Adapter<shopRecyclerAdapter2.ViewHolder>{
    ...
    public shopRecyclerAdapter2(){}

    public shopRecyclerAdapter2(ArrayList<product> productName, illess_shop shop) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_item4,parent,false);
